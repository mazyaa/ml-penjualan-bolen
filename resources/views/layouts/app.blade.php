        ...
        <div class="flex h-screen">
            ...
            <aside class="w-64 flex-shrink-0 hidden md:block bg-indigo-700 text-white shadow-lg">
                <div class="p-6 border-b border-indigo-500">
                    <a href="{{ route('dashboard') }}" class="text-2xl text-center font-bold tracking-tight text-white">
                        BOLEN AI 🍌
                    </a>
                </div>
                <nav class="mt-6 space-y-2">
                    ...
                    <a href="{{ route('resultOfClassification.index') }}"
                        class="flex items-center px-6 py-3 text-sm hover:bg-indigo-600 rounded-r-full transition-all {{ request()->routeIs('prediksi.*') ? 'bg-indigo-800' : '' }}">
